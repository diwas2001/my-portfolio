const siteMap = [
  ...
  {
    label: "Projects",
    desc: "A showcase of my academic and personal projects.",
  },
  { label: "Resume (CV)", desc: "Download my latest CV." },
  {
    label: "Contact",
    desc: "Send me an email directly through the contact form.",
  },
];
  ...
  return (
    <main className="min-h-screen px-4 pb-24">
      <section className="max-w-2xl mx-auto pt-8 text-center">
        ...
        <p className="fade-in-up delay-1 text-[#c3e88d] text-lg mt-8">
      ...
      <section className="fade-in-up max-w-2xl mx-auto">
        <div className="terminal">
          ...
          <div className="p-8">
            <p className="text-[#c3e88d] mb-4 text-lg">
              # What You'll Find on This Website
            </p>
            <ul className="space-y-3">
              {siteMap.map((item) => (
                <li key={item.label} className="text-sm">
                  <span className="text-[#82aaff] font-semibold">
                    {item.label}
                  </span>
